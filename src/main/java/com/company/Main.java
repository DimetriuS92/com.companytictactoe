...
public class Main {
    ...
    public static final byte bPoleSize = 3;
    // Задаем поле как (!)одномерный массив bPoleSize*bPoleSize
    public static String[] pole = new String[bPoleSize * bPoleSize];
    // задается текущий игрок
    public static byte bPlayerNum = 0;
     ...
     */
    public static boolean isValidInput(int iIn) {
